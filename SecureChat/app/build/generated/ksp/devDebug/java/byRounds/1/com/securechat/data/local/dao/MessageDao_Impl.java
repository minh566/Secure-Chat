  ...
  public MessageDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMessageEntity = new EntityInsertionAdapter<MessageEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `messages` (`id`,`roomId`,`senderId`,`senderName`,`content`,`type`,`fileUrl`,`fileName`,`localCachePath`,`isRead`,`deliveredToCsv`,`seenByCsv`,`reactionsCsv`,`createdAt`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getLocalCachePath() == null) {
          statement.bindNull(9);
        } else {
          statement.bindString(9, entity.getLocalCachePath());
        }
        final int _tmp = entity.isRead() ? 1 : 0;
        statement.bindLong(10, _tmp);
        statement.bindString(11, entity.getDeliveredToCsv());
        statement.bindString(12, entity.getSeenByCsv());
        statement.bindString(13, entity.getReactionsCsv());
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"messages"}, new Callable<List<MessageEntity>>() {
      ...
      public List<MessageEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfLocalCachePath = CursorUtil.getColumnIndexOrThrow(_cursor, "localCachePath");
          ...
          final int _cursorIndexOfReactionsCsv = CursorUtil.getColumnIndexOrThrow(_cursor, "reactionsCsv");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpLocalCachePath;
            if (_cursor.isNull(_cursorIndexOfLocalCachePath)) {
              _tmpLocalCachePath = null;
            } else {
              _tmpLocalCachePath = _cursor.getString(_cursorIndexOfLocalCachePath);
            }
            ...
            final String _tmpReactionsCsv;
            _tmpReactionsCsv = _cursor.getString(_cursorIndexOfReactionsCsv);
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _item = new MessageEntity(_tmpId,_tmpRoomId,_tmpSenderId,_tmpSenderName,_tmpContent,_tmpType,_tmpFileUrl,_tmpFileName,_tmpLocalCachePath,_tmpIsRead,_tmpDeliveredToCsv,_tmpSeenByCsv,_tmpReactionsCsv,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
